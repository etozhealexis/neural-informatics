...
set(gr2(2), 'Marker', 'o', 'Color', 'g', 'MarkerEdgeColor', 'k', 'MarkerFaceColor', 'r', 'MarkerSize', 7);
set(gr2(3), 'Marker', 'o', 'Color', 'b', 'MarkerEdgeColor', 'k', 'MarkerFaceColor', 'r', 'MarkerSize', 7);
set(gr2(4), 'Linestyle', '-', 'Color', 'k');
set(gr2(5), 'Linestyle', '-', 'Color', 'k');
set(gr2(6), 'Linestyle', '-', 'Color', 'k');
...
set(gr3(2), 'Marker', 'o', 'Color', 'g', 'MarkerEdgeColor', 'k', 'MarkerFaceColor', 'r', 'MarkerSize', 7);
set(gr3(3), 'Marker', 'o', 'Color', 'b', 'MarkerEdgeColor', 'k', 'MarkerFaceColor', 'r', 'MarkerSize', 7);
set(gr3(4), 'Linestyle', '-', 'Color', 'k');
set(gr3(5), 'Linestyle', '-', 'Color', 'k');
set(gr3(6), 'Linestyle', '-', 'Color', 'k');
